...
def get_planet_radius(planet_name: str) -> str:
    ...
    # TODO: fill this in
    pattern = "(Polar radius\s*)(?P<radius>[\d.]+)" #(finds radius)(add number to radius group)
...
def get_birth_date(name: str) -> str:
    ...
    # TODO: fill this in
    pattern = "(Born)(?P<name>\D+)(?P<birth>\d{4}-\d{2}-\d{2})" #(find the word born)(Adds in a name)(Adds numerical birthdate)
    error_text = (
